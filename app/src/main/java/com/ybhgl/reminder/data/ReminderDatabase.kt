...
@Database(entities = [ReminderItem::class, TagItem::class], version = 15, exportSchema = false)
...
abstract class ReminderDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE reminders ADD COLUMN customFontGlassTheme TEXT NOT NULL DEFAULT 'DARK'")
                db.execSQL("ALTER TABLE reminders ADD COLUMN customFontStrokeEnabled INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE reminders ADD COLUMN customFontStrokeColor TEXT NOT NULL DEFAULT ''")
            }
        }

        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE reminders ADD COLUMN customFontShadowEnabled INTEGER NOT NULL DEFAULT 0")
            }
        }

        private val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE reminders ADD COLUMN customFontWeight REAL NOT NULL DEFAULT 700")
            }
        }

        private val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE reminders ADD COLUMN customGlassBlur REAL NOT NULL DEFAULT 12.0")
                db.execSQL("ALTER TABLE reminders ADD COLUMN customGlassDensity REAL NOT NULL DEFAULT 0.13")
                db.execSQL("ALTER TABLE reminders ADD COLUMN customGlassRefraction REAL NOT NULL DEFAULT 0.3")
                db.execSQL("ALTER TABLE reminders ADD COLUMN customGlassHighlight REAL NOT NULL DEFAULT 0.6")
            }
        }

        private val MIGRATION_14_15 = object : Migration(14, 15) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE reminders ADD COLUMN endDate TEXT")
            }
        }
